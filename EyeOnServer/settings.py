"""
Django's settings for EyeOnServer project.
...
SECRET_KEY = 'django-insecure-ox$%wh-p0hua6nhvgw$qbj!tp%vz16*v9&q&gj^p3gpp^(0(mu'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*', ]  # 允许客户端访问您的服务器。
...
WSGI_APPLICATION = 'EyeOnServer.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'static/js/echarts'),
]
